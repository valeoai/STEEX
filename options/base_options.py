...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot',type=str,default='/path/to/data')
        ...
        parser.add_argument('--remove_saved_style_codes',type=bool,default=True)
        parser.add_argument('--results_dir', type=str, default='results_counterfactual', help='saves results here.')
        parser.add_argument('--save_initial_final_z',type=bool,default=True)
        parser.add_argument('--save_query_image',type=bool,default=False)
        parser.add_argument('--save_reconstruction',type=bool,default=True)
        ...
        parser.add_argument('--use_ground_truth_masks',type=bool,default=False)
